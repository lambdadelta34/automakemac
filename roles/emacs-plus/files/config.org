...
;;   :custom
;;   (awesome-tray-active-modules '("evil" "git" "file-path" "mode-name" "last-command" "awesome-tab" "location" "date"))
;;   (awesome-tray-essential-modules '("evil" "git" "mode-name"))
;;   (awesome-tray-mode-line-active-color "#d0d6ff")
;;   (awesome-tray-mode-line-inactive-color "#a9b4f6")
;;   (awesome-tray-update-interval 0.5)
;;   (awesome-tray-date-format "%d-%m %H:%M %a")
